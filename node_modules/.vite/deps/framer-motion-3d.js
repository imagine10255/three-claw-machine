...
var ExitAnimationFeature = class extends Feature {
  ...
  update() {
    if (!this.node.presenceContext)
      return;
    const { isPresent, onExitComplete, custom: custom2 } = this.node.presenceContext;
    const { isPresent: prevIsPresent } = this.node.prevPresenceContext || {};
    if (!this.node.animationState || isPresent === prevIsPresent) {
      return;
    }
    const exitAnimation = this.node.animationState.setActive("exit", !isPresent, { custom: custom2 !== null && custom2 !== void 0 ? custom2 : this.node.getProps().custom });
...
function useTap(isStatic, { whileTap, onTapStart, onTap, onTapCancel, onPointerDown }, visualElement) {
  ...
  const isPressing = (0, import_react45.useRef)(false);
  const cancelPointerEndListeners = (0, import_react45.useRef)(null);
...
var useRender = (Component3, props, ref, _state, isStatic, visualElement) => {
  ...
  return (0, import_react46.createElement)(Component3, Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ ref }, filterProps(props, false, false)), visualProps), { onUpdate: props.onInstanceUpdate }), useHover(isStatic, props, visualElement)), useTap(isStatic, props, visualElement)));
};
...
var MotionCanvasContext = (0, import_react47.createContext)(void 0);
...
function CanvasComponent(_a, forwardedRef) {
  ...
  const motionContext = (0, import_react48.useContext)(MotionContext);
  const configContext = (0, import_react48.useContext)(MotionConfigContext);
  const [forceRender] = useForceUpdate();
  const layoutCamera = (0, import_react48.useRef)(null);
  const dimensions = (0, import_react48.useRef)({
  ...
  (0, import_react48.useLayoutEffect)(handleResize, []);
  ...
  if (error)
    throw error;
  const root = (0, import_react48.useRef)();
...
var MotionCanvas = (0, import_react48.forwardRef)(CanvasComponent);
...
function useLayoutCamera({ makeDefault = true }, updateCamera) {
  const context = (0, import_react49.useContext)(MotionCanvasContext);
  ...
  const { visualElement: parentVisualElement } = (0, import_react49.useContext)(MotionContext);
  const measuredLayoutSize = (0, import_react49.useRef)();
